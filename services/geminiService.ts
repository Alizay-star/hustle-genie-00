...
// Fix: Adhere to Gemini API coding guidelines by using process.env.API_KEY for the API key.
// The API key is assumed to be pre-configured and available in the execution environment.
